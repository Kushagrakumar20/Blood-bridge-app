...
const Analytics = () => {
  ...
  const colors = ["#FFB200","#EB5B00","#E4003A","#708871","#03346E","#6EACDA","#7C00FE","#77E4C8"]
  ...
  return (
    <>
      ...
      <div className="d-flex flex-row flex-wrap">
        {data?.map((record,i) => (
          <div className="card m-2 p-1" style={{ width: '18rem', backgroundColor:`${colors[i]}`}} key={record._id}>
